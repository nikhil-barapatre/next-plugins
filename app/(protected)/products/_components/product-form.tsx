...
export default function ProductForm({ product }: ProductFormProps) {
  ...
  const form = useForm<ProductFormData>({
    ...
    defaultValues: {
      ...
      discountedPrice: product?.discounted_price ? String(product.discounted_price) : '',
      sku: product?.sku || '',
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="e.g. TSHIRT-BLK-LG" {...field} value={field.value ?? ''} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <FormControl>
                    <Input placeholder="e.g. Apparel" {...field} value={field.value ?? ''} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
              ...
              render={({ field }) => (
                <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4">
                  <div className="space-y-0.5">
                    ...
                    <FormDescription>
                      This product will be available for purchase.
                    </FormDescription>
                  </div>
                  <FormControl>
                    <Switch
